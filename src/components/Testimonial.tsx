...
export default function Testimonial({ testimonial, className = "" }: TestimonialProps) {
    return (
        <div className={`overflow-hidden rounded bg-white text-slate-500 shadow-2xl shadow-slate-200 ${className}`}>
            <div className="relative p-6">
                <figure className="relative z-10">
                    <blockquote className="p-6 text-lg leading-relaxed">
                        <p>{testimonial.comment}</p>
                    </blockquote>
                    <figcaption className="flex flex-col items-start gap-2 p-6 pt-0 text-sm" style={{ color: 'var(--color-primary)' }}>
                        <RatingStars rating={testimonial.rating} />
                        <div className="flex items-center gap-4 pt-4 text-sm" style={{ color: 'var(--color-primary)' }}>
                            {testimonial.image && (
                                <img
                ...
                >
                    <path
                        ...
                        style={{ fill: 'var(--color-secondary-light)' }}
                    />
                </svg>
            </div>
        </div>
